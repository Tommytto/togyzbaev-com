export function startAnimation(e) {
  console.log(e);
  /**
...
//
  ...
  THREE.CanvasRenderer = function (parameters) {
    ...
    const _clearColor = new THREE.Color(0xff0000);
    let _clearAlpha = 1;
...
//
  ...
  if ($('.j-something-else').length > 0) {
    var SEPARATION = 200; var AMOUNTX = 40; var
        AMOUNTY = 60;
    var container; let
        stats;
    var camera; var scene; var
        renderer;

    var particles; var particle; var
        count = 0;

    const mouseX = 0; const
        mouseY = 0;
